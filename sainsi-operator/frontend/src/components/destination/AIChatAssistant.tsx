  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 p-4 bg-indigo-600 text-white rounded-full shadow-2xl hover:bg-indigo-500 transition-transform hover:scale-105 focus-visible:ring-2 focus-visible:ring-indigo-500 z-50 flex items-center justify-center"
      >
          ...
          >
            <div className="p-4 bg-gray-800 border-b border-gray-700 flex justify-between items-center">
              ...
              <button
                ...
                className="text-gray-400 hover:text-white focus-visible:ring-2 focus-visible:ring-indigo-500 rounded"
              >
                <X className="h-5 w-5" />
              </button>
            </div>
            ...
            <div className="p-3 bg-gray-800 border-t border-gray-700">
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-2 top-2 p-1 text-indigo-400 hover:text-indigo-300 focus-visible:ring-2 focus-visible:ring-indigo-500 rounded"
                >
