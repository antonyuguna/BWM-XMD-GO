        ...
        {isOpen && (
          ...
          >
            <div className="p-4 bg-gray-800 border-b border-gray-700 flex justify-between items-center">
              ...
              <button onClick={() => setIsOpen(false)} aria-label="Close AI Assistant" className="text-gray-400 hover:text-white">
                <X className="h-5 w-5" />
              </button>
            </div>
            ...
            <div className="p-3 bg-gray-800 border-t border-gray-700">
              <div className="relative">
                ...
                />
                <button aria-label="Send message" className="absolute right-2 top-2 p-1 text-indigo-400 hover:text-indigo-300">
